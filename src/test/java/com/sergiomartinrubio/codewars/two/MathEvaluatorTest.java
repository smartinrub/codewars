...
public class MathEvaluatorTest {
    ...
    @Test
    public void test2() {
        assertEquals(new MathEvaluator().calculate("12*-1"), -12, 0.01);
    }
    ...
    @Test
    public void test4() {
        assertEquals(new MathEvaluator().calculate("((80 - (19)))"), 61, 0.01);
    }
    ...
    @Test
    public void test6() {
        assertEquals(new MathEvaluator().calculate("1 - -(-(-(-4)))"), -3, 0.01);
    }
